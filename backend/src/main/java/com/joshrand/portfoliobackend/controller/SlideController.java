...
@CrossOrigin(originPatterns = {"https://joshrand.xyz","https://www.joshrand.xyz", "http://localhost:4200", "http://localhost:80", "http://localhost" , "http://192.168.1.187:4200", "http://192.168.1.167:4200", "http://143.198.178.176", "http://172.18.0.3:4200"}, methods = {RequestMethod.POST ,RequestMethod.GET, RequestMethod.PUT, RequestMethod.DELETE})
@RestController
